...
# sounds
hi_hat = mixer.Sound(source+r'\sounds\hi hat.wav')
snare = mixer.Sound(source+r'\sounds\snare.wav')
kick = mixer.Sound(source+r'\sounds\kick.wav')
crash = mixer.Sound(source+r'\sounds\crash.wav')
clap = mixer.Sound(source+r'\sounds\clap.wav')
tom = mixer.Sound(source+r'\sounds\tom.wav')

screen = pygame.display.set_mode([WIDTH, HEIGHT])
pygame.display.set_caption('The Beat Maker')
label_font = pygame.font.Font(source+r'\Roboto-Bold.ttf', 32)
medium_font = pygame.font.Font(source+r'\Roboto-Bold.ttf', 24)
beat_changed = True
...
load_menu = False
saved_beats = []
file = open(source+r'\saved_beats.txt', 'r')
for line in file:
